...
#PROMPT=$'%{$purple%}%n%{$reset_color%} Culting at %{$limegreen%}%m%{$reset_color%} in %{$hotpink%}%~%{$reset_color%} $vcs_info_msg_0_
PROMPT=$'%{$purple%}%n%{$reset_color%} Culting at %{$marrom%}%m%{$reset_color%} in %{$hotpink%}%~%{$reset_color%} $vcs_info_msg_0_
%{$limeblue%}水%{$reset_color%} '
